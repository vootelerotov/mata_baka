...
Progarammiteek on kättesaadav aadressil {\color{red} SIIA AADRESS}

Järgnevalt esitame hinnangute implementatsioonid programmeerimiskeeles Python 2.
...
Käesoleva töö sissejuhatuses kirjeldasime viisi, kuidas vaikimisi teisendatakse vastused Likerti skaalalt  intervallskaalale. {\color{red}Märgime, et selline tõlgendus ei ole põhjendatud -- meil ei ole mingit teoreetilist põhjust eeldada, et kõik vastused on üksteisest sama "kaugel".}
